...
import stampTypeCategoriesRouter from '@modules/stamps/infra/http/routes/stampTypeCategories.routes';
...
routes.use('/stampTypeCategories', stampTypeCategoriesRouter);
