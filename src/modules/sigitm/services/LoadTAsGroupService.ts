...
export default class LoadTAsGroupService {
  ...
  public async execute(): Promise<IResponse> {
    const tas = await this.sigitmTAsRepository.findByStatusAndTipoRede({
      status1: 10,
      status2: 70,
      tipoRede1: 304,
      tipoRede2: 305,
      ...
      data: {
        t0h: {
          ...
          ids: tasGroup[filaNome].t0h
            ? tasGroup[filaNome].t0h.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t12h: {
          nome: '+12h',
          ...
          ids: tasGroup[filaNome].t12h
            ? tasGroup[filaNome].t12h.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t1d: {
          nome: '+1d',
          ...
          ids: tasGroup[filaNome].t1d
            ? tasGroup[filaNome].t1d.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t3d: {
          nome: '+3d',
          ...
          ids: tasGroup[filaNome].t3d
            ? tasGroup[filaNome].t3d.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t7d: {
          nome: '+7d',
          ...
          ids: tasGroup[filaNome].t7d
            ? tasGroup[filaNome].t7d.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t15d: {
          nome: '+15d',
          ...
          ids: tasGroup[filaNome].t15d
            ? tasGroup[filaNome].t15d.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t30d: {
          nome: '+30d',
          ...
          ids: tasGroup[filaNome].t30d
            ? tasGroup[filaNome].t30d.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t60d: {
          nome: '+60d',
          ...
          ids: tasGroup[filaNome].t60d
            ? tasGroup[filaNome].t60d.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t120d: {
          nome: '+120d',
          ...
          ids: tasGroup[filaNome].t120d
            ? tasGroup[filaNome].t120d.map((ta: SigitmTA) => ta.id)
            : [],
        },
        t365d: {
          nome: '+365d',
          ...
          ids: tasGroup[filaNome].t365d
            ? tasGroup[filaNome].t365d.map((ta: SigitmTA) => ta.id)
            : [],
        },
      },
    }));
